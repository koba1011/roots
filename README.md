...
Rootsは、ユーザーのルーツ（地元、思い出、好き）を共有する旅行専門動画投稿アプリです。
...
海外旅行したい！と思ったのが制作したきっかけでした。<br />
というのも私自身海外旅行に一度も行ったこともなく憧れがあり、さらに今このご時世海外旅行は中々行けるものではありません。<br />
そこで、家にいながら世界中の景色を見て少しでも旅行気分が味わえたらなと思い制作しました。<br />
そして、動画を見るだけではなくユーザー自身が好きな場所、お気に入りの景色を共有することでその場所の活性化。世界中の人と景色を見ながら交流できるようにと考えています。
...
それと投稿詳細画面でGooglマップを使って場所を表示する機能です。Youtubeなど他の動画投稿サイトと差別化するために実装しました。この機能を実装したことでよりその投稿場所の雰囲気や、情報を得られるようになったと思います。<br />
